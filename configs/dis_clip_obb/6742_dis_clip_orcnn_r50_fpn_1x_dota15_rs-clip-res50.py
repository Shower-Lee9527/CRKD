...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        task='Task1',
        ann_file='data/split_ss_dota1_5/trainval/annfiles/',
        img_prefix='data/split_ss_dota1_5/trainval/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadOBBAnnotations',
    ...
    test=dict(
        type='DOTADataset',
        task='Task1',
        ann_file='data/split_ss_dota1_5/test/annfiles/',
        img_prefix='data/split_ss_dota1_5/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipRotateAug',
...
model = dict(
    ...
    distillation=dict(
        ...
        clip_encoder_name='/mnt/disk/Detection-TGARS/OBBDetection-master/RemoteCLIP-RN50.pt',
        obj_weight=0.1,
        con_weight=0.05,
        sem_weight=0.1,
        unfreeze=None),
